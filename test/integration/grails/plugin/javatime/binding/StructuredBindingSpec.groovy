...
class StructuredBindingSpec extends Specification {
	...
	void 'can bind to a top level field'() {
		...
		then:
		person.name == 'Alex'
		person.birthday == LocalDate.of(2008, 10, 2)
	}
	...
	void 'can bind to an associated field'() {
		...
		person.child.birthday == LocalDate.of(2008, 10, 2)
	}
	...
	void 'can bind to an embedded field'() {
		...
		person.boss.birthday == LocalDate.of(2008, 10, 2)
	}
	...
	void 'can bind to a collection field'() {
		...
		event.dates == [LocalDate.of(2012, 11, 9), LocalDate.of(2012, 12, 13)]
	}
